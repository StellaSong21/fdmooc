...
<div class="card">
    ...
    <div class="container card-body">
        ...
        <div class="input-group input-group-lg">
            ...
            <input type="text" class="form-control" id="username" onblur="check()" placeholder="不得包含特殊符号">
            <span class="input-group-addon alert" id="us"></span>
        </div>

        <div class="input-group input-group-lg">
            <span class="input-group-addon">PASSWORD </span>
            <input type="password" class="form-control" id="password" placeholder="大于6位 非纯数字">
        ...
        <div class="input-group input-group-lg">
            ...
            <span class="input-group-addon" id="vs" alert></span>
        </div>
